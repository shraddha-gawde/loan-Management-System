...
generalData(){
  ...
  refreshData() {
    const url = `${this.baseURL}batch?page=${this.currentPage}&limit=${this.limit}&BatchID=${this.BatchID}&status=accepted&fileName=${this.fileName}&region=${this.region}&programType=${this.programType}&sortBy=${this.sortBy}&sortOrder=${this.sortOrder}`;
  ...
  getInvoiceData(batchid: string) {
    this.parameterBatchID = batchid;
    console.log(this.parameterBatchID);
    const url = `${this.baseURL}invoices/${batchid}?page=${this.currentPage}&limit=${this.limit}&invoice_number=${this.invoice_number}&status=accepted&customer_name=${this.customer_name}&sortBy=${this.sortBy}&sortOrder=${this.sortOrder}`;
  ...
  acceptInvoice() {
    ...
    const url = `${this.baseURL}disburse/${id}`;
    this.httpClient
